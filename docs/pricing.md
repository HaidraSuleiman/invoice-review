...
| Azure Container Apps + ACR + Azure Files | Consumption hosting in West Europe | Small standing cost for registry, storage, Log Analytics, and the always-on replica | Ingress and CPU/memory while the Container App runs; DI/OpenAI usage unchanged |
